...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4">
      <div className="max-w-md w-full bg-white rounded-[20px] shadow-xl p-8 text-center">
        ...
        <button 
          ...
          className="w-full bg-primary text-white rounded-xl py-3.5 font-bold hover:bg-[#d6335e] transition-colors flex items-center justify-center gap-2"
        >
