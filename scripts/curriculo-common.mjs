...
// para que Node cargue .env.local automaticamente (requiere Node 20+).
function loadFirebaseConfig() {
  ...
  if (missing.length > 0) {
    console.error("[curriculo-common] Faltan variables de entorno:", missing.join(", "))
    console.error("Ejecuta el script con: node --env-file=.env.local scripts/<nombre>.mjs")
    process.exit(1)
  }
  return cfg
}
