...
import { firebaseConfig } from "./curriculo-common.mjs"

// Las credenciales vienen de variables de entorno via curriculo-common.mjs.
// Ejecutar: node --env-file=.env.local scripts/seed-curriculo.mjs
